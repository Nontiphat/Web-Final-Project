<template>
  <div class="container">
    ...
    <div class="product-header">
      <br />
      <br />
      <h2>ส่วนจัดการ Notebook</h2>


      <div class="create-product">
        <button class="btn btn-success btn-sm" v-on:click="navigateTo('/product/create')">Add Notebook</button>
        <strong>จํานวน Notebook:</strong>
        {{results.length}}
      </div>
    ...
    <transition-group name="fade">
      <div v-for="product in products" v-bind:key="product.id" class="product-list">
        ...
        <div class="product-info">
          ...
          <p>
            <button class="btn btn-primary" v-on:click="navigateTo('/product/'+ product.id)">View Notebook</button>
            <button
